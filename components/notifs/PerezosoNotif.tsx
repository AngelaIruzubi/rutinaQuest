...
const TIPOS_BAJA_MEDALLA = new Set([
  "bajaOroPlata",
  "bajaPlatabronce",
  "bajaBronceSin",
]);

const MEDALLA_THEME: Record<
  string,
  { color: string; bg: string; glow: string; emoji: string; label: string }
> = {
  bronce: {
    color: "#CD7F32",
    bg: "#1A1100",
  ...
  bajaBronceSin: {
    ...
    glow: "rgba(205,127,50,0.10)",
    emoji: "💔",
    label: "Perdiste tu medalla de Bronce",
  },
};
...
function CorazonRoto({ color }: { color: string }) {
  ...
  return (
    ...
    >
      <Text allowFontScaling={false} style={{ fontSize: 72, lineHeight: 80 }}>
        💔
      </Text>
    </Animated.View>
  );
...
function NotifNormal({
  ...
  return (
    <Animated.View
      ...
      style={[
        estilo.overlay,
        { backgroundColor: "#F9FBF8", opacity: opacityAnim },
      ]}
      accessibilityElementsHidden
        ...
        style={[
          estilo.card,
          {
            transform: [
              ...
              { scale: Animated.multiply(scaleAnim, bounceAnim) as any },
            ],
          },
        ]}
      >
        ...
        <Text
          ...
          style={[estilo.text, { color: cfg.color }]}
        >
          {cfg.msg}
        </Text>
        {cfg.sub && (
          ...
          >
            <Text allowFontScaling={false} style={estilo.ctaText}>
              {cfg.sub}
            </Text>
          </TouchableOpacity>
        )}
...
function NotifMedalla({
  ...
  const particles = useRef<ConfettiParticle[]>(
    makeConfettiParticles(theme.color),
  ).current;
  ...
  useEffect(() => {
    ...
    textY.setValue(reduceMotion ? 0 : 30);
    ctaScale.setValue(reduceMotion ? 1 : 0.7);
  ...
  return (
    <Animated.View
      ...
      style={[
        estilo.screen,
        { backgroundColor: theme.bg, opacity: overlayOpacity },
      ]}
      accessibilityElementsHidden
      importantForAccessibility="no-hide-descendants"
    >
      <View style={StyleSheet.absoluteFill} pointerEvents="none">
        {particles.map((p, i) => {
          const rotateDeg = p.rot.interpolate({
            inputRange: [0, 1],
      ...
      <View
        pointerEvents="none"
        style={[estilo.bgGlow, { backgroundColor: theme.glow }]}
      />
      ...
      >
        <Text
          allowFontScaling={false}
          style={[estilo.medalLabel, { color: theme.color }]}
        >
          {theme.label}
        </Text>
        <Text allowFontScaling={false} style={estilo.msg}>
          {cfg.msg}
        </Text>
        <Text
          allowFontScaling={false}
          style={[estilo.subtitle, { color: theme.color + "99" }]}
        >
      ...
      >
        <TouchableOpacity
          style={[estilo.ctaBtn, { backgroundColor: theme.color }]}
          activeOpacity={0.8}
          onPress={onClose}
          accessibilityRole="button"
          accessibilityLabel="Cerrar notificación de medalla"
        >
          <Text allowFontScaling={false} style={estilo.ctaText}>
            ¡A por la siguiente!
          </Text>
  ...
  return (
    ...
    >
      ...
      {type !== "bajaBronceSin" && (
        <View
          pointerEvents="none"
          style={[estilo.bgGlow, { backgroundColor: theme.glow, top: "15%" }]}
        />
      )}
      {/* Mascota con shake */}
      <Animated.View
      ...
      >
        <Image
          ...
          accessibilityIgnoresInvertColors
        />
        {type === "bajaBronceSin" && <CorazonRoto color={theme.color} />}
      </Animated.View>
      ...
      >
        ...
        <Text
          allowFontScaling={false}
          style={[estilo.subtitle, { color: theme.color + "88" }]}
        >
          Completa tareas a tiempo para recuperarla
        </Text>
      </Animated.View>
      ...
      >
        <TouchableOpacity
          ...
          onPress={onClose}
          accessibilityRole="button"
          accessibilityLabel="Cerrar notificación de bajada de medalla"
        >
          <Text
            allowFontScaling={false}
            style={[estilo.ctaText, { color: theme.color }]}
          >
            Voy a recuperarla
          </Text>
        </TouchableOpacity>
